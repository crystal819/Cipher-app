...
Another import I made was Figure from matplotlib.figure which is the object oriented way of using matplotlib, not needing to rely on matplotlib.pyplot which is the global state which will make it much harder when trying to implement it into a tkinter app.

I have implemented several hidden features which I encourage you to look around to try and find.